...
INSERT INTO TABLE_PRODUCT (id_product, name, description, price_product, stock) VALUES (2, 'Découvrez Maytea, une boisson a base de véritable infusion de thé, mariée aux saveurs subtiles de fruits et de plantes', 'MAYTEA Parfum MENTHE', 0.84, 1634)
INSERT INTO TABLE_PRODUCT (id_product, name, description, price_product, stock) VALUES (3, 'BMW i3', 'La BMW i3 ne suit aucune tendance, elle est l’expression d’un style de vie assumé. Son langage stylistique futuriste lui confère également de la clarté à l’extérieur et une ambiance « lounge » à l’intérieur..', 39950.00, 3)
INSERT INTO TABLE_PRODUCT (id_product, name, description, price_product, stock) VALUES (4, 'One Piece - Tome 1 : À l’aube d’une grande aventure', 'Il y a quelque temps existait un homme, Gold Roger, répondant au titre de Roi des pirates. Lors de son exécution, le souverain des mers prononça quelques mots, déclarant avoir caché son trésor, le One Piece, quelque part dans le monde, et quiconque pouvait s’en emparer.', 6.90, 17)
INSERT INTO TABLE_PRODUCT (id_product, name, description, price_product, stock) VALUES (5, 'One Piece - Tome 2 : Aux prises avec Baggy et ses hommes !', 'Luffy atterrit sur une île occupée par Baggy et son groupe, un équipage de pirates redoutable.', 6.90, 12)
INSERT INTO TABLE_PRODUCT (id_product, name, description, price_product, stock) VALUES (6, 'One Piece - Tome 3 : Une vérité qui blesse', 'Luffy affronte Baggy. Ce dernier admet vouer une haine sans nom envers Shanks. En effet, tous deux ont appris les rudiments de la piraterie sur le même navire, et un malencontreux incident a provoqué la descente aux enfers de Baggy…' , 6.90, 11)
...
-- TABLE ORDER
INSERT INTO TABLE_ORDER (id_order, date, price_order, id_customer, id_address, id_order_status) VALUES (1, '29/10/2020', 8.4, 2, 2, 0)
INSERT INTO TABLE_ORDER (id_order, date, price_order, id_customer, id_address, id_order_status) VALUES (2, '29/10/2020', 229.00, 3, 3, 0)
INSERT INTO TABLE_ORDER (id_order, date, price_order, id_customer, id_address, id_order_status) VALUES (3, '29/10/2020', 52950.00, 1, 1, 0)
INSERT INTO TABLE_ORDER (id_order, date, price_order, id_customer, id_address, id_order_status) VALUES (4, '29/10/2020', 20.7, 4, 4, 0)
