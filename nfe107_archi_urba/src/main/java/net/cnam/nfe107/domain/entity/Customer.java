...
public class Customer {
    ...
    public Customer(Long idCustomer, String firstname, String lastname, String email, String phoneNumber, Long loyaltyPoints, List<Address> addresses, List<Order> orders) {
        this.idCustomer = idCustomer;
        this.firstname = firstname;
        this.lastname = lastname;
        this.email = email;
